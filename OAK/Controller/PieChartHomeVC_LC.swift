...
class PieChartHomeVC_LC: UIViewController {
    ...
    @IBOutlet var scrollView_outlet: UIScrollView!
    @IBOutlet var mainParentView_outlet: UIView!
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //scrollView_outlet.contentSize = CGSize(width: self.view.frame.size.width, height: 36600)
